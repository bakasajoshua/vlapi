...
* 
*/
class Agesapi_model extends MY_Model
{
	...
	function ages_outcomes($year=NULL,$month=NULL)
	{
		...
		$data["county_outcomes"][0]["data"] = array_fill(0, 7, 0);
		$data["county_outcomes"][1]["data"] = array_fill(0, 7, 0);

		foreach ($info as $key => $value) {
			$result = $value['Results']['TotalByAge'];
			$data["county_outcomes"][0]["data"][1] += $result['NonSuppressedBelowAge2'];
			$data["county_outcomes"][0]["data"][2] += $result['NonSuppressedBelowAge10'];
			$data["county_outcomes"][0]["data"][3] += $result['NonSuppressedBelowAge15'];
			$data["county_outcomes"][0]["data"][4] += $result['NonSuppressedBelowAge20'];
			$data["county_outcomes"][0]["data"][5] += $result['NonSuppressedAboveAge25'];
			$data["county_outcomes"][0]["data"][6] += $result['NonSuppressedNoAge'];

			$data["county_outcomes"][1]["data"][1] += $result['SupressedBelowAge2'];
			$data["county_outcomes"][1]["data"][2] += $result['SupressedBelowAge10'];
			$data["county_outcomes"][1]["data"][3] += $result['SupressedBelowAge15'];
			$data["county_outcomes"][1]["data"][4] += $result['SupressedBelowAge20'];
			$data["county_outcomes"][1]["data"][5] += $result['SupressedAboveAge25'];
			$data["county_outcomes"][1]["data"][6] += $result['SupressedNoAge'];
		}
